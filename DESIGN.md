...
- **Built-in themes** ship with the app as starting points to copy and edit: Classic (the default dark look), Frutiger Aero, Aero Glass, Liquid Glass, and Rainy Window (a blurred night city with rain falling outside, behind drops on the glass that refract the lights and slide down in fits and starts; the layers drift at different speeds as you scroll, and messages are glossy liquid glass bubbles).
